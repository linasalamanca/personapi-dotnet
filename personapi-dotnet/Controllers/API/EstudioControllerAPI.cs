...
namespace personapi_dotnet.Controllers
{
    ...
    {
        private readonly IEstudioRepository _estudiosRepository;
        private readonly IPersonaRepository _personaRepository;
        private readonly IProfesionRepository _profesionRepository;

        public EstudioController(IEstudioRepository estudiosRepository, IPersonaRepository personaRepository, IProfesionRepository profesionRepository)
        {
